...
import list from '@/app/utils/constants/portfolio/list';
import List from './List';
import HighlightMenuList from '@/app/utils/services/menu_highlight/highlight_menu';
...
import Loading from '@/app/ui/components/common/loading/Loading';
    ...
    <>
      ...
      <ul className={styles.menu}>
        ...
        {status === 'unauthenticated' && (
          <li className={`${styles.auth} ${didactGothic.className}`} onClick={() => router.push('/login')}>
            Login
          </li>
        )}
      </ul>
